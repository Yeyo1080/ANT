...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (t1 != null) {
        ...
        t2 = t1.$ti;
        t2._eval$1("~(1)?")._as(A.add__agren$closure());
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t1._target, t1._eventType, A.add__agren$closure(), false, t2._precomputed1);
      }
    },
    agren(e) {
      var elemento, t1;
      type$.MouseEvent._as(e);
      elemento = A.Element_Element$html('<div class="farmaciasim"><a href="https://yeyo1080.github.io/sires1/agree.html"><img src="pino2.jpg" alt="prueba"></a><div class="texto2" width="200px"></div></div>');
      t1 = document.body;
      if (t1 != null)
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "add__agren$closure", "agren", 17);
  })();
